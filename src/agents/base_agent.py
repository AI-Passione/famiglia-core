...
from src.agents.souls.soul_registry import load_agent_soul, resolve_agent_id
from src.agents.llm.models_registry import TASK_ROUTING
from src.agents.orchestration.on_demand_supervisor import OnDemandMasterSupervisor
from src.agents.orchestration.utils.state import AgentState
from src.agents.orchestration.scheduling_supervisor import setup_scheduling_supervisor_graph
from src.agents.orchestration.utils.task_helpers import TaskTools
from src.agents.utils.skills import CommonSkills
from src.observability.langfuse_util import langfuse_manager

# New modular imports
from src.agents.orchestration.utils.task_helpers import (
    TASK_TYPE_REMINDER,
...
class BaseAgent(CommonSkills, TaskTools, OnDemandMasterSupervisor):
    def __init__(
        ...
        if "global_fallback" not in self.model_config:
            from src.agents.llm.models_registry import DEFAULT_OLLAMA_FALLBACK_MODEL
