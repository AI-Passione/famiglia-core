...
from famiglia_core.agents.orchestration.features.analytics.simple_data_analysis import setup_data_analysis_graph
from famiglia_core.agents.orchestration.features.analytics.deep_dive_analysis import setup_deep_dive_analysis_graph
from famiglia_core.agents.orchestration.features.analytics.data_ingestion import setup_data_ingestion_graph
...
class OnDemandMasterSupervisor:
    ...
    def _finalize_response(self, state: AgentState) -> str:
        ...
        # 1. Final Response Assignment
        final_text = response
        
        # 2. Persist & Distribute
        # BaseAgent handles the core "first-class" terminal persistence via Distributor
